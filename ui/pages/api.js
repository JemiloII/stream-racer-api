...
const GROUPS = [
  ["Race state", [
    ...
    { method: "GET", path: "/inventory/:login", summary: "What a racer has left: boosts and chat respawns", description: "`respawns` is -1 when `settings.respawnLimit` is 0 (unlimited). Chat respawns count against the limit; the streamer's POST /respawn does not. Bots answer `!race inv` with this.", params: [TARGET], response: { login: "shibikox", displayName: "ShibikoX", boosts: 1, respawns: 2, respawnLimit: 2, running: true }, errors: "404 no vehicle" },
