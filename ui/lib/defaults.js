...
export const OVERLAY_DEFAULTS = {
  size: 40, names: true, spread: -1, accent: "#ffd400", line: "rgba(255,255,255,.35)", lineHeight: 6, offsetY: 0, side: 24, banner: true, nameColors: true, spreadMode: "field", showInLobby: false,
...
export const MINIMAP_DEFAULTS = { enabled: true, x: 0.02, y: 0.03, w: 0.18, h: 0, marker: 3, bg: "#000000", alpha: 0, track: "#ffffff", pad: 1.15, leaderBig: true, names: true, mapTitle: true, mapAuthor: false, mapTitleAlign: "center", mapAuthorAlign: "center", showInLobby: false, aspect: "1:1" };
